...
from new_frontera import Settings, FrontierTester
from new_frontera.utils import graphs
from new_frontera.utils.tester import BaseDownloaderSimulator


class BasicCrawlingStrategy(BaseCrawlingStrategy):
    def __init__(self, manager, args, scheduled_stream, states_context):
        super(BasicCrawlingStrategy, self).__init__(
            manager, args, scheduled_stream, states_context
        )
        self._id = 0
    ...
    def _create_request(self, url):
        r = self.create_request(
            ...
            meta={b"this_param": b"should be passed over", b"id": self._id},
        )
        self._id += 1
        return r
...
class BackendTest(object):
    ...
    :class:`Backend <new_frontera.core.components.Backend>` testing.
    """
...
class BackendSequenceTest(BackendTest):
    ...
    :class:`Backend <new_frontera.core.components.Backend>` crawling sequences.
    """
    ...
    def get_sequence(
        ...
        """
        Returns an new_frontera iteration sequence from a site list
    ...
    def get_url_sequence(
        ...
        """
        sequence = []
        for requests, iteration, dl_info in self.get_sequence(
