...
if __name__ == '__main__':
    test_logic('new_frontera.contrib.backends.memory.FIFO')
    test_logic('new_frontera.contrib.backends.memory.LIFO')
    test_logic('new_frontera.contrib.backends.memory.BFS')
    test_logic('new_frontera.contrib.backends.memory.DFS')
    test_logic('new_frontera.contrib.backends.memory.RANDOM')
