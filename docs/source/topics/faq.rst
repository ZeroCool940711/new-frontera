...
The solution is to supply new_frontera backend with hostname/ip (usually, but not necessary) usage in downloader. We
have a keyword arguments in method :attr:`get_next_requests <new_frontera.core.components.Backend.get_next_requests>`
...
:class:`FrontierManagerWrapper <new_frontera.utils.managers.FrontierManagerWrapper>` subclass to backend.
