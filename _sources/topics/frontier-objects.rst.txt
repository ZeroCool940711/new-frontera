...
Frontier uses 2 object types: :class:`Request <new_frontera.core.models.Request>`
and :class:`Response <new_frontera.core.models.Response>`. They are used to represent crawling HTTP requests and
...
.. autoclass:: new_frontera.core.models.Request
    :members:
...
.. autoclass:: new_frontera.core.models.Response
    :members:
...
By default, new_frontera activates the :ref:`fingerprint middleware <frontier-url-fingerprint-middleware>` to
generate a unique fingerprint calculated from the :attr:`Request.url <new_frontera.core.models.Request.url>`
and :attr:`Response.url <new_frontera.core.models.Response.url>` fields, which is added to the
:attr:`Request.meta <new_frontera.core.models.Request.meta>` and
:attr:`Response.meta <new_frontera.core.models.Response.meta>` fields respectively. You can use
this middleware or implement your own method to manage frontier objects identification.

An example of a generated fingerprint for a :class:`Request <new_frontera.core.models.Request>` object::
...
:attr:`Request.meta <new_frontera.core.models.Request.meta>` and
:attr:`Response.meta <new_frontera.core.models.Response.meta>` fields.
